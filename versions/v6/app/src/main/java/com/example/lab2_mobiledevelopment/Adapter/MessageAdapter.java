...
//        This is to for checking the last message
//        if (stu_position == mChat.size()-1) {
//            if (chat.isStu_seen()) {
//                holder.stu_txtSeen.setText("Seen");
//            } else {
//                holder.stu_txtSeen.setText("Delivered");
//            }
//        } else {
//            holder.stu_txtSeen.setVisibility(View.GONE);
//        }
    }
...
//            stu_txtSeen = itemView.findViewById(R.id.stu_txt_seen);
